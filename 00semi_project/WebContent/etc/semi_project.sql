...
DROP TABLE SM3_PURCHASE_LIST CASCADE CONSTRAINTS;
...
DROP TABLE SM3_PURCHASE CASCADE CONSTRAINTS;
...
CREATE TABLE SM3_PURCHASE_LIST
(
	PL_NUM number NOT NULL,
	PUR_NUM number,
	SIZE_NUM number,
	ORDER_CNT number(4,0),
	ITEM_PRICE number(7,0),
...
ALTER TABLE SM3_ORDER
	ADD FOREIGN KEY (PUR_NUM)
	REFERENCES SM3_PURCHASE (PUR_NUM)
;
