									...
									<div class="col-sm-8 loginBox">
										<div
											...
											<div class="box-content">
												<h4 class="heading-primary text-uppercase mb-md">아이디찾기</h4>
														...
														<div class="form-group">
															<div class="col-md-12">
																<label for="email1">이메일</label>
																	 <span class="spanVal"></span><input id="email1" name="user_email" 
																		size="8" type="text"
																		class="form-control input-lg" value=""> @ <input
																		id="email2" name="user_email"size="8"
																		type="text" class="form-control input-lg" value="">
															</div>
														</div>
													</div>
													<div class="row">
														<div class="col-md-6" style="margin-top: 40px">
															<a class="btn btn-primary pull-right mb-xl"
																href="javascript:findId()">아이디찾기</a>
														</div>
													</div>
												</form>
											</div>
...
<script type="text/javascript">
	...
	function findId(){
		...
		xhr.open('post', 'userControll.do?cmd=findId', true);
		...
		var suser_email=document.getElementsByName("user_email");
		var user_email=suser_email[0].value + "@" + suser_email[1].value;
		var param= "user_phone=" + user_phone +"&user_email=" + user_email;
		xhr.send(param);
	}
	function callback(){
		if(xhr.readyState==4 && xhr.status==200){
			...
			modalMsg.innerHTML=json.user_id;
