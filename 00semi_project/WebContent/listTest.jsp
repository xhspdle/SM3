											...
											<tbody>
												<c:forEach var="vo" items="${list}">
													<tr>
														...
														<td><a href="<c:url value='user_update.jsp?user_num=${vo.user_num }&user_id=${vo.user_id }&user_pwd=${vo.user_pwd }&user_name=${vo.user_name}&user_email=${vo.user_email}&user_phone=${vo.user_phone}&user_post_addr=${vo.user_post_addr}&user_basic_addr=${vo.user_basic_addr}&user_detail_addr=${vo.user_detail_addr}'/>">수정</a></td>
														<td>삭제</td>
													</tr>
												</c:forEach>
											</tbody>
										...
										<ul class="pagination pull-center">
											...
											<c:forEach var="i" begin="${startPage}" end="${endPage}">
												<c:choose>
													<c:when test="${i == pageNum}">
														<li class="active"><a
															href="<c:url value='userControll.do?cmd=list&search=${search}&keyword=${keyword}'/>">${i}</a></li>
													</c:when>
													<c:otherwise>
														<li><a
															href="<c:url value='userControll.do?cmd=list&search=${search}&keyword=${keyword}'/>">${i}</a></li>
											...
											<c:choose>
												<c:when test="${endPage < pageCount}">
													<li><a
														href="<c:url value='userControll.do?cmd=list&pageNum=${endPage+1}&search=${search}&keyword=${keyword}'/>"><i
															class="fa fa-chevron-left"></i></a></li>
												</c:when>
												<c:otherwise>
