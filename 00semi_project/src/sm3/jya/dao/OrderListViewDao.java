		...
		try {
			...
			if (rs.next()) {
				do {
					...
					OrderListViewVo vo = new OrderListViewVo(order_num1, user_num, item_num,pur_num, item_name, item_orgimg,
		...
		try {
			...
			if (rs.next()) {
				do {
					...
					int order_status = rs.getInt("order_status");
					Date order_date = rs.getDate("order_date");
					OrderListViewVo vo = new OrderListViewVo(order_num1, user_num, pur_num, item_num, item_name, item_orgimg,
							item_info, order_cnt, order_pay, order_recipient, order_phone, order_basic_addr,
							order_detail_addr, order_point, order_status, order_date);
					list.add(vo);
				} while (rs.next());
		...
		try {
			...
			if (rs.next()) {
				do {
					...
					int order_status = rs.getInt("order_status");
					Date order_date = rs.getDate("order_date");
					OrderListViewVo vo=new OrderListViewVo(order_num, user_num, pur_num, item_num, item_name, item_orgimg, item_info, order_cnt,
